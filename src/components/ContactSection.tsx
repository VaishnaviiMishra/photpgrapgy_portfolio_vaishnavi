          ...
          <div className="lg:col-span-7 p-6 sm:p-8 bg-[#3F212B]/90 backdrop-blur-md rounded-3xl border border-white/10 space-y-6 shadow-2xl relative overflow-hidden">
            ...
            <div className="space-y-1">
              ...
              <p className="text-xs text-rose-200/80">
                Choose your service and details to directly dispatch your shoot request via WhatsApp or Email.
              </p>
            </div>

            {isSentSuccess && (
              <div className="p-4 rounded-2xl bg-emerald-950/60 border border-emerald-500/40 text-emerald-200 text-xs flex items-center gap-2.5 shadow-lg">
                <Check className="w-4 h-4 text-emerald-400 shrink-0" />
                <span>Inquiry opened successfully! Complete sending in WhatsApp or your Email client.</span>
              </div>
            )}
            ...
            <form className="space-y-4">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div className="space-y-1.5">
                  <label className="text-xs font-medium text-rose-200/80">Your Name / Organization</label>
                  <input
                    type="text"
                    required
                    placeholder="e.g., Vaishnavi / GDG Organizer"
                    value={form.name}
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div className="space-y-1.5">
                  <label className="text-xs font-medium text-rose-200/80">Your Email or WhatsApp Phone</label>
                  <input
                    type="text"
              ...
              <div className="space-y-1.5">
                ...
                <input
                  type="text"
                  placeholder="e.g., Delhi NCR / Studio / Outdoor Park"
                  value={form.location}
            ...
            {/* Action Buttons: WhatsApp and Email Pills */}
            <div className="pt-3 flex flex-wrap gap-3">
              <button
                type="button"
                onClick={handleWhatsAppSend}
                className="flex-1 min-w-[200px] py-3.5 rounded-full bg-gradient-to-r from-[#DE4373] to-[#BF2C5B] hover:from-[#E84E7E] hover:to-[#CE3666] text-white text-xs font-bold shadow-lg shadow-pink-950/40 hover:scale-105 transition-all flex items-center justify-center gap-2 cursor-pointer"
                id="send-whatsapp-btn"
              >
                <Phone className="w-3.5 h-3.5" />
                <span>Send via WhatsApp (+91-8826402661)</span>
              </button>

              <button
                type="button"
                onClick={handleEmailSend}
                className="flex-1 min-w-[160px] py-3.5 rounded-full bg-[#4E2735] hover:bg-[#5D3040] text-white border border-white/15 hover:border-[#DE4373]/50 text-xs font-bold transition-all flex items-center justify-center gap-2 cursor-pointer shadow"
                id="send-email-btn"
              >
